...
Each of these runs in the browser, with no install and no sign-in.
...
in Python, with no SUMO and no SimPy. Compares Webster-timed fixed signals,
...
dock-clearing cards, plus an operator dispatch view over the same data. A design
...
**[aula-virtual-mcp](https://github.com/ruud0/aula-virtual-mcp)**: an MCP server for
Blackboard Learn: courses, grades, assignments and file downloads, over headless
Playwright sessions with institutional SSO.

**[claude-relay](https://github.com/ruud0/claude-relay)**: an MCP server for
...
**[ig-autoposter](https://github.com/ruud0/ig-autoposter)**: an end-to-end Instagram
